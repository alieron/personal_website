<template>
  <div class="nav-btn-cont">  
    <router-link id="prev-btn" @click="this.$emit('direction', 'slide-left')" v-if="this.$route.meta.prev" :to="{ name: this.$route.meta.prev }">
    ...
    <router-link id="next-btn" @click="this.$emit('direction', 'slide-right')" v-if="this.$route.meta.next" :to="{ name: this.$route.meta.next }">
