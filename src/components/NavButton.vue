<template>
  <div class="nav-btn-cont">  
    <router-link @click="$emit('direction', 'slide-left')" v-if="this.$route.meta.prev" :to="{ name: this.$route.meta.prev }">
    ...
    <router-link @click="$emit('direction', 'slide-right')" v-if="this.$route.meta.next" :to="{ name: this.$route.meta.next }">
