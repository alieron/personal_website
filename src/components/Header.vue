<template>
  <div class="header">
    <nav class="social">
      <a class="icon1" tabindex="-1" href="https://www.linkedin.com/in/sebastien-leib/" target="_blank">
        <svg class="social-btn" tabindex="1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <a class="icon2" tabindex="-1" href="https://github.com/alieron" target="_blank">
        <svg class="social-btn" tabindex="2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path
...
.social .social-btn:hover, .social-btn:focus {
  fill: var(--clr-accent);
}
</style>